...
class ColQwen2_5_Processor(BaseVisualRetrieverProcessor, Qwen2VLProcessor):  # noqa: N801
    ...
    def process_vl_chat(
        ...
        **kwargs
        ...
        """
        Process inputs for VL chat mode, bypassing ColQwen2_5's custom processing.
        
        This method uses the original Qwen2VLProcessor processing pipeline for standard VL chat functionality.
        
        Args:
            text: Text input(s) for the model
            images: Optional image(s) for the model
            videos: Optional video(s) for the model
            **kwargs: Additional arguments to pass to the parent processor
            
        Returns:
            BatchFeature with processed inputs in Qwen2.5-VL format
        """
        # Use the parent Qwen2VLProcessor's __call__ method directly
    ...
    def apply_chat_template(self, *args, **kwargs):
        """
        Apply chat template for VL chat mode, using the original Qwen2VLProcessor's chat template.
        
        This method allows the processor to format messages in the same way as the original Qwen2.5-VL.
        
        Args:
            *args: Arguments to pass to the parent apply_chat_template method
            **kwargs: Keyword arguments to pass to the parent apply_chat_template method
    ...
    def batch_decode(self, *args, **kwargs):
        """
        Batch decode tokens for VL chat mode, using the original Qwen2VLProcessor's batch_decode method.
        
        Args:
            *args: Arguments to pass to the parent batch_decode method
            **kwargs: Keyword arguments to pass to the parent batch_decode method
